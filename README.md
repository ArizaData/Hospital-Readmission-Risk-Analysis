...
3. Risk Bucketing: Used SQL to bin continuous data into categories (e.g., visits grouped as 0, 1-4, or 5+).

4. Visualization: Imported the final SQL segments into Power BI to generate targeted charts to support findings. 
